...
ATrollRushCharacter::ATrollRushCharacter()
{
	...
	InteractComponent = CreateDefaultSubobject<UTRInteractComponent>(TEXT("InteractComp"));
...
void ATrollRushCharacter::SetupPlayerInputComponent(UInputComponent* PlayerInputComponent)
{
	...
	if (UEnhancedInputComponent* EnhancedInputComponent = Cast<UEnhancedInputComponent>(PlayerInputComponent)) {
		...
		// Moving
		EnhancedInputComponent->BindAction(MoveAction, ETriggerEvent::Triggered, this, &ATrollRushCharacter::Move);
...
void ATrollRushCharacter::Move(const FInputActionValue& Value)
{
	// input is a Vector2D
...
void ATrollRushCharacter::Look(const FInputActionValue& Value)
{
	// input is a Vector2D
